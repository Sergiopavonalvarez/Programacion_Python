...
class Login(QMainWindow):
    ...
    def entrar(self):
        ...
        if (usuario==valor_a and contraseña==valor_b):
         ...
         self.input_a.clear()
        self.input_b.clear()
        self.input_a.setPlaceholderText("Usuario incorrecto")
        self.input_b.setPlaceholderText("Usuario incorrecto")
        ventana_dialogo = QDialog(self)
        ventana_dialogo.setWindowTitle("Ventana de dialogo")
        ventana_dialogo.resize(600, 500)
        etiqueta1 = QLabel("Usuario o contraseña incorrectos", ventana_dialogo)
        fuente = etiqueta1.font()
        fuente.setPointSize(30)
        etiqueta1.setFont(fuente)
        ventana_dialogo.exec()
