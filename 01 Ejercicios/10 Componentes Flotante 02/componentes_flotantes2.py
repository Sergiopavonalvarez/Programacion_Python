...
from PySide6.QtWidgets import QMainWindow, QApplication, QToolBar, QLabel, QDockWidget, QTextEdit, QWhatsThis
...
class comp_flotantes(QMainWindow):
    def __init__(Self):
        ...
        ruta=os.path.join(os.path.dirname(__file__),"C:/Users/pavon/Documents/PyCharm/Python_Dam/Python/00 Ejercicios/10 Componentes Flotantes 2/imagen.png")
        accion=QAction(QIcon("C:/Users/pavon/Documents/PyCharm/Python_Dam/Python/00 Ejercicios/10 Componentes Flotantes 2/imagen.png"),"Imprimir...",Self)

        accion.setWhatsThis("Al pulsar sobre el boton...")
        accion.setStatusTip("Modo ayuda")
