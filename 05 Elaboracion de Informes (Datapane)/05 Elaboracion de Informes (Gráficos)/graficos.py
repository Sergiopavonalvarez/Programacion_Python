...
fichero_csv = "C:/Users/pavon/Documents/PyCharm/Programacion_Python/05 Elaboracion de informes (Datapane)/05 Elaboracion de Informes (Gráficos)/DI_U05_A02_02.csv"
...
report.save(path="C:/Users/pavon/Documents/PyCharm/Programacion_Python/05 Elaboracion de informes (Datapane)/05 Elaboracion de Informes (Gráficos)/Informe_barras(Sinagrupar en columnas).html", open=True)
#report.save(path="C:/Users/pavon/Documents/PyCharm/Programacion_Python/05 Elaboracion de informes (Datapane)/05 Elaboracion de Informes (Gráficos)/Informe_barras(Agrupados en columnas).html", open=True)
#report.save(path="C:/Users/pavon/Documents/PyCharm/Programacion_Python/05 Elaboracion de informes (Datapane)/05 Elaboracion de Informes (Gráficos)/Informe).html", open=True)
