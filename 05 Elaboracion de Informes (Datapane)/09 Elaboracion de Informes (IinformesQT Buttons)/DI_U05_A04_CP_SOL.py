...
class VentanaInformes(QWidget):
    ...
    def abrir_informe_01(self):
        ...
        ruta_absoluta = "C:/Users/pavon/Documents/PyCharm/Programacion_Python/05 Elaboracion de informes (Datapane)/09 Elaboracion de Informes (IinformesQT Buttons)/Informe01.html"
    ...
    def abrir_informe_02(self):
        ...
        ruta_absoluta = "C:/Users/pavon/Documents/PyCharm/Programacion_Python/05 Elaboracion de informes (Datapane)/09 Elaboracion de Informes (IinformesQT Buttons)/Informe02.html"
        QDesktopServices.openUrl(QUrl.fromLocalFile(ruta_absoluta))
    ...
    def abrir_informe_03(self):
        ...
        ruta_absoluta = "C:/Users/pavon/Documents/PyCharm/Programacion_Python/05 Elaboracion de informes (Datapane)/09 Elaboracion de Informes (IinformesQT Buttons)/Informe03.html"
        QDesktopServices.openUrl(QUrl.fromLocalFile(ruta_absoluta))
